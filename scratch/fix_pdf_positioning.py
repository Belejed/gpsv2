...
# Find and replace downloadPDFReport block to fix positioning
print("Replacing downloadPDFReport function with viewport-aligned rendering position...")
...
if start_idx is not None and end_idx is not None:
    ...
    print("downloadPDFReport function updated successfully with fixed positioning styles.")
else:

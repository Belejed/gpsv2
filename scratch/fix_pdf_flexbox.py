...
# 1. Update downloadPDFReport function with a 100% flexbox-free layout
...
if start_idx is not None and end_idx is not None:
    ...
    print("downloadPDFReport function updated successfully with traditional grid and no flexbox in td cells.")
else:
